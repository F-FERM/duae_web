    ...
    >
      ...
      >
          ...
          <div className="flex min-w-max px-[20px] sm:px-[28px]">
            {TABS.map((tab) => (
              <button
                ...
                className={`border-b-[2px] px-[12px] py-[10px] text-[12px] font-medium whitespace-nowrap transition-colors sm:text-[13px] ${activeTab === tab
        ...
        <div className="flex-1 overflow-y-auto p-[20px] sm:p-[28px]">
          {activeTab === "Basic" && (
            <BasicTab form={form} setField={setField} uploading={uploading} setUploading={setUploading} />
          )}
          {activeTab === "Hero" && (
            <HeroTab form={form} setField={setField} uploading={uploadingHero} setUploading={setUploadingHero} />
          )}
          {activeTab === "Stats" && (
            <StatsTab form={form} setField={setField} />
          )}
          {activeTab === "Who We Serve" && (
            <WhoWeServeTab form={form} setForm={setForm} setField={setField} />
          )}
          {activeTab === "What's Included" && (
            <WhatIsIncludedTab form={form} setForm={setForm} setField={setField} />
          )}
          {activeTab === "CTA" && (
            <CtaTab form={form} setField={setField} uploading={uploadingCta} setUploading={setUploadingCta} />
          )}
          {activeTab === "About" && (
            <AboutTab form={form} setField={setField} uploading={uploadingAbout} setUploading={setUploadingAbout} />
          )}
          {activeTab === "Process" && (
            <ProcessTab form={form} setForm={setForm} setField={setField} />
          )}
          {activeTab === "Materials" && (
            <MaterialsTab form={form} setForm={setForm} setField={setField} />
          )}
          {activeTab === "Why Choose Us" && (
            <WhyChooseUsTab form={form} setForm={setForm} setField={setField} />
          )}
          {activeTab === "FAQs" && (
            <FaqsTab form={form} setForm={setForm} />
          )}
          {activeTab === "Contact" && (
            <ContactTab form={form} setField={setField} />
          )}
          {activeTab === "SEO" && (
            <SeoTab form={form} setField={setField} setForm={setForm} />
          )}
          {activeTab === "Trusted Works" && (
            <TrustedWorksTab form={form} setForm={setForm} setField={setField} />
          )}
        </div>
  ...
  return (
    <div className="grid gap-[16px] sm:grid-cols-2">
      ...
      <Field label="Icon (Font Awesome class)">
        <input className={inputCls} value={form.icon} onChange={(e) => setField("icon", e.target.value)} placeholder="fa-solid fa-hammer" />
      </Field>
      <Field label="Order">
      ...
      <div className="sm:col-span-2">
        <Field label="Short Description">
          <textarea className={textareaCls} value={form.shortDescription} onChange={(e) => setField("shortDescription", e.target.value)} />
        </Field>
      </div>
      <div className="sm:col-span-2">
        <Field label="Full Description">
          <textarea className={textareaCls} style={{ minHeight: 120 }} value={form.fullDescription} onChange={(e) => setField("fullDescription", e.target.value)} />
        </Field>
      </div>
      <div className="sm:col-span-2 flex flex-wrap gap-[20px] pt-[4px]">
        ...
        <Field label="Parent Service ID">
          <input className={inputCls} value={form.parentService || ''} onChange={(e) => setField("parentService", e.target.value || null)} placeholder="null" />
        </Field>
      </div>
    </div>
  );
    ...
    <div className="grid gap-[16px] sm:grid-cols-2">
      <div className="sm:col-span-2">
        <Field label="Hero Title">
          <input className={inputCls} value={form.heroTitle} onChange={(e) => setField("heroTitle", e.target.value)} />
        </Field>
      </div>
      <div className="sm:col-span-2">
        <Field label="Hero Subtitle">
          <textarea className={textareaCls} value={form.heroSubtitle} onChange={(e) => setField("heroSubtitle", e.target.value)} />
        </Field>
      </div>
      <div className="sm:col-span-2">
        <ImageUpload
  ...
  return (
    <div className="grid gap-[16px] sm:grid-cols-2">
      <Field label="Years of Excellence">
        <input type="number" className={inputCls} value={s.yearsOfExcellence} onChange={(e) => setField("stats.yearsOfExcellence", Number(e.target.value))} />
      </Field>
      <Field label="Years Label">
        <input className={inputCls} value={s.yearsLabel} onChange={(e) => setField("stats.yearsLabel", e.target.value)} />
      </Field>
      <Field label="Skilled Professionals">
        <input type="number" className={inputCls} value={s.skilledProfessionals} onChange={(e) => setField("stats.skilledProfessionals", Number(e.target.value))} />
      </Field>
      <Field label="Professionals Label">
        <input className={inputCls} value={s.professionalsLabel} onChange={(e) => setField("stats.professionalsLabel", e.target.value)} />
      </Field>
      <Field label="Successful Projects">
        <input type="number" className={inputCls} value={s.successfulProjects} onChange={(e) => setField("stats.successfulProjects", Number(e.target.value))} />
      </Field>
      <Field label="Projects Label">
        <input className={inputCls} value={s.projectsLabel} onChange={(e) => setField("stats.projectsLabel", e.target.value)} />
      </Field>
      <Field label="Happy Clients">
        <input type="number" className={inputCls} value={s.happyClients} onChange={(e) => setField("stats.happyClients", Number(e.target.value))} />
      </Field>
      <Field label="Clients Label">
        <input className={inputCls} value={s.clientsLabel} onChange={(e) => setField("stats.clientsLabel", e.target.value)} />
      </Field>
    </div>
  );
}
...
function CtaTab({
  ...
  return (
    <div className="grid gap-[16px] sm:grid-cols-2">
      <div className="sm:col-span-2">
        <Field label="Title"><input className={inputCls} value={cta.title} onChange={(e) => setField("cta.title", e.target.value)} /></Field>
      </div>
      <div className="sm:col-span-2">
        <Field label="Subtitle"><textarea className={textareaCls} value={cta.subtitle} onChange={(e) => setField("cta.subtitle", e.target.value)} /></Field>
      </div>
      <Field label="Button Text"><input className={inputCls} value={cta.buttonText} onChange={(e) => setField("cta.buttonText", e.target.value)} /></Field>
...
function AboutTab({
  ...
  return (
    <div className="grid gap-[16px] sm:grid-cols-2">
      <div className="sm:col-span-2">
        <Field label="Title"><input className={inputCls} value={about.title} onChange={(e) => setField("about.title", e.target.value)} /></Field>
      </div>
      <div className="sm:col-span-2">
        <Field label="Description"><textarea className={textareaCls} style={{ minHeight: 100 }} value={about.description} onChange={(e) => setField("about.description", e.target.value)} /></Field>
      </div>
      <div className="sm:col-span-2">
        <ImageUpload
          value={about.image}
      ...
      <Field label="Founded Year"><input className={inputCls} value={about.foundedYear} onChange={(e) => setField("about.foundedYear", e.target.value)} /></Field>
      <Field label="Outlets"><input type="number" className={inputCls} value={about.outlets} onChange={(e) => setField("about.outlets", Number(e.target.value))} /></Field>
      <Field label="Team Size"><input type="number" className={inputCls} value={about.teamSize} onChange={(e) => setField("about.teamSize", Number(e.target.value))} /></Field>
      <div className="sm:col-span-2">
        <Field label="Factory Info"><textarea className={textareaCls} value={about.factoryInfo} onChange={(e) => setField("about.factoryInfo", e.target.value)} /></Field>
      </div>
    </div>
  );
}
...
function ProcessTab({
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <Field label="Section Title"><input className={inputCls} value={section.title} onChange={(e) => setField("process.title", e.target.value)} /></Field>
      <Field label="Section Description"><textarea className={textareaCls} value={section.description} onChange={(e) => setField("process.description", e.target.value)} /></Field>
      ...
      {(section.steps ?? []).map((step, idx) => (
        <ItemCard key={idx} title={step.title || `Step ${step.step}`} onRemove={() => removeStep(idx)}>
          <div className="grid gap-[12px] sm:grid-cols-2">
            <Field label="Step No."><input className={inputCls} value={step.step} onChange={(e) => updateStep(idx, "step", e.target.value)} /></Field>
            <Field label="Icon"><input className={inputCls} value={step.icon} onChange={(e) => updateStep(idx, "icon", e.target.value)} /></Field>
            <div className="sm:col-span-2">
              <Field label="Title"><input className={inputCls} value={step.title} onChange={(e) => updateStep(idx, "title", e.target.value)} /></Field>
            </div>
            <div className="sm:col-span-2">
              <Field label="Description"><textarea className={textareaCls} value={step.description} onChange={(e) => updateStep(idx, "description", e.target.value)} /></Field>
            </div>
          </div>
        </ItemCard>
      ))}
...
function MaterialsTab({
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <Field label="Section Title"><input className={inputCls} value={section.title} onChange={(e) => setField("materials.title", e.target.value)} /></Field>
      <Field label="Section Description"><textarea className={textareaCls} value={section.description} onChange={(e) => setField("materials.description", e.target.value)} /></Field>
      <p className="text-[11px] font-semibold uppercase tracking-widest text-[#888888]">Items</p>
      {(section.items ?? []).map((item, idx) => (
...
function WhyChooseUsTab({
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <Field label="Section Title"><input className={inputCls} value={section.title} onChange={(e) => setField("whyChooseUs.title", e.target.value)} /></Field>
      <p className="text-[11px] font-semibold uppercase tracking-widest text-[#888888]">Items</p>
      {(section.items ?? []).map((item, idx) => (
        <ItemCard key={idx} title={item.title || `Item ${idx + 1}`} onRemove={() => removeItem(idx)}>
          <div className="grid gap-[12px] sm:grid-cols-2">
    ...
    <div className="flex flex-col gap-[14px]">
      {(form.faqs ?? []).map((faq, idx) => (
        <ItemCard key={idx} title={faq.question || `FAQ ${idx + 1}`} onRemove={() => removeFaq(idx)}>
          <Field label="Question"><input className={inputCls} value={faq.question} onChange={(e) => updateFaq(idx, "question", e.target.value)} /></Field>
          <div className="mt-[10px]">
            <Field label="Answer"><textarea className={textareaCls} value={faq.answer} onChange={(e) => updateFaq(idx, "answer", e.target.value)} /></Field>
          </div>
        </ItemCard>
      ))}
...
function ContactTab({
  ...
  return (
    <div className="grid gap-[16px] sm:grid-cols-2">
      <div className="sm:col-span-2">
        <Field label="Title"><input className={inputCls} value={contact.title} onChange={(e) => setField("contact.title", e.target.value)} /></Field>
      </div>
      <div className="sm:col-span-2">
        <Field label="Description"><textarea className={textareaCls} value={contact.description} onChange={(e) => setField("contact.description", e.target.value)} /></Field>
      </div>
      <div className="sm:col-span-2">
...
function SeoTab({
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <Field label="Meta Title"><input className={inputCls} value={seo.metaTitle} onChange={(e) => setField("seo.metaTitle", e.target.value)} /></Field>
      <Field label="Meta Description"><textarea className={textareaCls} value={seo.metaDescription} onChange={(e) => setField("seo.metaDescription", e.target.value)} /></Field>
...
function TrustedWorksTab({
  ...
  return (
    <div className="flex flex-col gap-[16px]">
      <Field label="Section Title">
        <input className={inputCls} value={trusted.title} onChange={(e) => setField("trustedJoineryWorks.title", e.target.value)} />
      </Field>
      <Field label="Section Description">
      ...
      <div className="mx-auto flex max-w-[1600px] flex-col gap-[16px] sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-[6px] text-[13px] leading-[1.6] text-[#666666] sm:text-[14px] lg:text-[15px]">
            Click a card to edit its details.
          </p>
        </div>
                ...
                >
                  <Card
                    ...
                    className="
                      ...
                      transition-all
                      duration-300
                      hover:shadow-[0_18px_50px_rgba(234,88,12,0.18)]
                      hover:ring-2
                      hover:ring-[#EA580C]/30
                      sm:rounded-[22px]
                    "
                  >
                    {/* IMAGE */}
