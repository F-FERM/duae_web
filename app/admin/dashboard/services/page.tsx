        ...
        >
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto p-[20px] sm:p-[28px]">
                    {activeTab === "Basic" && (
                        <BasicTab form={form} setField={setField} />
                    )}
                    {activeTab === "Hero" && (
                        <HeroTab form={form} setField={setField} />
                    )}
                    {activeTab === "Stats" && (
                    ...
                    {activeTab === "CTA" && (
                        <CtaTab form={form} setField={setField} />
                    )}
                    {activeTab === "About" && (
                        <AboutTab form={form} setField={setField} />
                    )}
                    {activeTab === "Process" && (
...
function BasicTab({
    ...
    return (
        <div className="grid gap-[16px] sm:grid-cols-2">
            ...
            <div className="flex flex-col gap-[10px] pt-[4px] sm:pt-[20px]">
        ...
        <div className="grid gap-[16px] sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
                <Field label="Hero Image Path">
                    <input className={inputCls} value={form.heroImage} onChange={(e) => setField("heroImage", e.target.value)} placeholder="/images/services/.../hero-bg.jpg" />
                </Field>
            </div>
        </div>
    );
...
function WhoWeServeTab({
    ...
    const addItem = () => {
        setForm((prev) => {
            ...
            clone.whoWeServe.items.push({ title: "", description: "", image: "", icon: "" });
            return clone;
        });
    };
...
function CtaTab({
    ...
    return (
        <div className="grid gap-[16px] sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
                <Field label="CTA Image Path"><input className={inputCls} value={cta.image} onChange={(e) => setField("cta.image", e.target.value)} /></Field>
            </div>
        </div>
    );
}
...
function AboutTab({
    ...
    return (
        <div className="grid gap-[16px] sm:grid-cols-2">
            ...
            <Field label="Image Path"><input className={inputCls} value={about.image} onChange={(e) => setField("about.image", e.target.value)} /></Field>
